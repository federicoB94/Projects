...
-- START automatically  generated VHDL the Thu Dec 27 16:03:20 2018 
    if    std_match(addr, "------------------00------------") then
      sel := 0; -- regs / base 0x00000000 / mask 0x00001000
    elsif std_match(addr, "------------------01------------") then
      sel := 1; -- regs_fir / base 0x00001000 / mask 0x00001000
    elsif std_match(addr, "------------------10------------") then
      sel := 2; -- reg_size / base 0x00002000 / mask 0x00002000
