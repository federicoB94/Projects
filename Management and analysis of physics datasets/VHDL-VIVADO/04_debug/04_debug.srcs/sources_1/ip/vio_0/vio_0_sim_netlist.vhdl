...
-- Date        : Thu Sep 19 11:40:38 2019
-- Host        : agostini-XPS-15 running 64-bit Ubuntu 18.04.3 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /mnt/DATA/SharedFolders/University/Magistrale/Anno1_Sem1/MAPD/FPGA/Exercise/04_debug/04_debug.srcs/sources_1/ip/vio_0/vio_0_sim_netlist.vhdl
-- Design      : vio_0
...
entity vio_0_vio_v3_0_20_decoder is
  port (
    ...
    \G_PROBE_OUT[3].wr_probe_out[3]_i_3_0\ : out STD_LOGIC;
    \G_PROBE_OUT[3].wr_probe_out[3]_i_4_0\ : out STD_LOGIC;
...
architecture STRUCTURE of vio_0_vio_v3_0_20_decoder is
  ...
  signal \^g_probe_out[3].wr_probe_out[3]_i_3_0\ : STD_LOGIC;
  signal \^g_probe_out[3].wr_probe_out[3]_i_4_0\ : STD_LOGIC;
...
begin
  \G_PROBE_OUT[3].wr_probe_out[3]_i_3_0\ <= \^g_probe_out[3].wr_probe_out[3]_i_3_0\;
  \G_PROBE_OUT[3].wr_probe_out[3]_i_4_0\ <= \^g_probe_out[3].wr_probe_out[3]_i_4_0\;
  SR(0) <= \^sr\(0);
  in0 <= \^in0\;
...
\G_PROBE_OUT[3].wr_probe_out[3]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\G_PROBE_OUT[3].wr_probe_out[3]_i_5\: unisim.vcomponents.LUT6
    generic map(
...
\rd_en[6]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
        ...
        port map (
      I0 => \rd_en[6]_i_2_n_0\,
      I1 => \^g_probe_out[3].wr_probe_out[3]_i_3_0\,
      I2 => \^g_probe_out[3].wr_probe_out[3]_i_4_0\,
      I3 => \^s_den_o_inst_0\,
      O => \rd_en[6]_i_1_n_0\
    );
...
\wr_en[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \^g_probe_out[3].wr_probe_out[3]_i_4_0\,
      I4 => \^s_den_o_inst_0\,
      I5 => s_dwe_o,
      O => \wr_en[2]_i_1_n_0\
    );
...
\wr_en[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => \^s_den_o_inst_0\,
      I3 => \^g_probe_out[3].wr_probe_out[3]_i_4_0\,
      I4 => \^g_probe_out[3].wr_probe_out[3]_i_3_0\,
      O => \wr_en[4]_i_1_n_0\
    );
...
DECODER_INST: entity work.vio_0_vio_v3_0_20_decoder
     port map (
      ...
      \G_PROBE_OUT[3].wr_probe_out[3]_i_3_0\ => DECODER_INST_n_5,
      \G_PROBE_OUT[3].wr_probe_out[3]_i_4_0\ => DECODER_INST_n_6,
...
PROBE_OUT_ALL_INST: entity work.vio_0_vio_v3_0_20_probe_out_all
     port map (
      ...
      \G_PROBE_OUT[3].wr_probe_out_reg[3]_1\ => DECODER_INST_n_6,
      \G_PROBE_OUT[3].wr_probe_out_reg[3]_2\ => DECODER_INST_n_7,
